...
final class InstallerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDumpVersionsClass()
    {
        ...
        $expectedPath = $vendorDir . '/muglug/package-versions/src/PackageVersions';
...
PHP;
    ...
    public function testDumpsVersionsClassToSpecificLocation(RootPackageInterface $rootPackage, $inVendor)
    {
        ...
        $expectedPath      = $inVendor
            ? $vendorDir . '/muglug/package-versions/src/PackageVersions'
    ...
    public function rootPackageProvider()
    {
        ...
        $packageVersionsRootPackage              = new RootPackage('muglug/package-versions', '1.2.3', '1.2.3');
        ...
        return [
            'root package is not muglug/package-versions' => [
                $baseRootPackage,
                true
            ],
            'alias root package is not muglug/package-versions' => [
                $aliasRootPackage,
                true
            ],
            'indirect alias root package is not muglug/package-versions' => [
                $indirectAliasRootPackage,
                true
            ],
            'root package is muglug/package-versions' => [
                $packageVersionsRootPackage,
                false
            ],
            'alias root package is muglug/package-versions' => [
                $aliasPackageVersionsRootPackage,
                false
            ],
            'indirect alias root package is muglug/package-versions' => [
